...
communitiesRouter.get('/my-communities', verifyAuth, (0, request_validator_middleware_1.validateDataMiddleware)(communitiesValidator.getMyCommunitiesValidator, 'query'), (0, watch_async_controller_1.WatchAsyncController)(controller_1.default.getAllUserCommunities));
communitiesRouter.get('/explore', verifyAuth, (0, watch_async_controller_1.WatchAsyncController)(controller_1.default.exploreCommunities));
communitiesRouter.get('/search', verifyAuth, (0, request_validator_middleware_1.validateDataMiddleware)(communitiesValidator.searchCommunitiesValidator, 'query'), (0, watch_async_controller_1.WatchAsyncController)(controller_1.default.searchCommunities));
communitiesRouter.get('/user/:userId/created', verifyAuth, (0, request_validator_middleware_1.validateDataMiddleware)(communitiesValidator.getMyCommunitiesValidator, 'query'), (0, watch_async_controller_1.WatchAsyncController)(controller_1.default.getUserCreatedCommunities));
communitiesRouter.get('/user/:userId/joined', verifyAuth, (0, request_validator_middleware_1.validateDataMiddleware)(communitiesValidator.getMyCommunitiesValidator, 'query'), (0, watch_async_controller_1.WatchAsyncController)(controller_1.default.getUserJoinedCommunities));
