...
const notificationsValidator = __importStar(require("./validator"));
...
notificationsRouter.get('/', verifyAuth, (0, request_validator_middleware_1.validateDataMiddleware)(notificationsValidator.getNotificationsQueryValidator, 'query'), (0, watch_async_controller_1.WatchAsyncController)(controller_1.default.getNotifications));
notificationsRouter.get('/unread-count', verifyAuth, (0, watch_async_controller_1.WatchAsyncController)(controller_1.default.getUnreadCount));
