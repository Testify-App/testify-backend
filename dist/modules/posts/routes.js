...
postsRouter.get('/:id/reposts', verifyAuth, (0, request_validator_middleware_1.validateDataMiddleware)(postsValidator.idValidator, 'params'), (0, request_validator_middleware_1.validateDataMiddleware)(postsValidator.getRepostsQueryValidator, 'query'), (0, watch_async_controller_1.WatchAsyncController)(controller_1.default.getPostReposts));
...
postsRouter.post('/:id/bookmark', verifyAuth, (0, request_validator_middleware_1.validateDataMiddleware)(postsValidator.idValidator, 'params'), (0, watch_async_controller_1.WatchAsyncController)(controller_1.default.bookmarkPost));
postsRouter.delete('/:id/bookmark', verifyAuth, (0, request_validator_middleware_1.validateDataMiddleware)(postsValidator.idValidator, 'params'), (0, watch_async_controller_1.WatchAsyncController)(controller_1.default.unbookmarkPost));
postsRouter.post('/:id/comments', verifyAuth, (0, request_validator_middleware_1.validateDataMiddleware)(postsValidator.idValidator, 'params'), (0, request_validator_middleware_1.validateDataMiddleware)(postsValidator.createCommentValidator, 'body'), (0, watch_async_controller_1.WatchAsyncController)(controller_1.default.createComment));
postsRouter.get('/:id/comments', verifyAuth, (0, request_validator_middleware_1.validateDataMiddleware)(postsValidator.idValidator, 'params'), (0, request_validator_middleware_1.validateDataMiddleware)(postsValidator.getCommentsQueryValidator, 'query'), (0, watch_async_controller_1.WatchAsyncController)(controller_1.default.getComments));
postsRouter.get('/comments/:comment_id/replies', verifyAuth, (0, request_validator_middleware_1.validateDataMiddleware)(postsValidator.commentReplyParamValidator, 'params'), (0, request_validator_middleware_1.validateDataMiddleware)(postsValidator.getCommentsQueryValidator, 'query'), (0, watch_async_controller_1.WatchAsyncController)(controller_1.default.getCommentReplies));
