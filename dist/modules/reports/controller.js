...
class ReportsController {
    constructor() {
        this.createReport = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield services_1.default.createReport(dto);
            ...
            return ResponseBuilder.success(res, 'Content reported successfully', http_status_codes_1.StatusCodes.CREATED, response);
        });
        this.getReports = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const query = new dtos.GetReportsQueryDTO(req.query);
            const response = yield services_1.default.getReports(query);
            if (response instanceof errors_1.BadException) {
                return ResponseBuilder.error(res, response, http_status_codes_1.StatusCodes.BAD_REQUEST);
            }
            return ResponseBuilder.success(res, 'Reports retrieved successfully', http_status_codes_1.StatusCodes.OK, response);
        });
        this.reviewReport = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            return ResponseBuilder.success(res, 'Report updated successfully', http_status_codes_1.StatusCodes.OK, response);
        });
    }
}
