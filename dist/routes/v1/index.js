...
const routes_9 = __importDefault(require("../../modules/stories/routes"));
...
appRouter.use("/stories", routes_9.default);
appRouter.use("/reports", routes_10.default);
appRouter.use("/uploads", routes_11.default);
